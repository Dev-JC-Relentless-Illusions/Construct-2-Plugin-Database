...
Modplayer.prototype.createContext = function()
{
  ...
  //this.volumeNode.gain.value=4.0; dynamic change !!!
  // mixer
  ...
  // compressor for a bit of volume boost, helps with multich tunes // removed for now .. gtr
//  this.compressorNode=this.context.createDynamicsCompressor();

  // patch up some cables :)
  this.mixerNode.connect(this.volumeNode);
 ...
 // we have now Gain + 2 Filter node 
}
