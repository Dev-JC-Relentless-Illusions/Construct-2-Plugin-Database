...
//if (typeof (Protracker) === "undefined") var Protracker = {};
...
function Protracker()
{
  ...
  this.bufferstodelay=2; // adjust this if you get stutter after loading new song
  this.delayfirst=0;
  this.delayload=0;
...
Protracker.prototype.createContext = function()
{
 ...
 // this.lowpassNode.frequency.value=28867;
  this.filter=false;
// --- gtr for global volume nodeName
 ...
 // this.compressorNode=this.context.createDynamicsCompressor();
  ...
  this.mixerNode.connect(this.volNode);
  this.volNode.connect(this.analyzer);
   
//   this.analyzer.connect(this.filterNode); 
...
Protracker.prototype.getfreq = function(st)
{
      var freqByteData = new Uint8Array(this.analyzer.frequencyBinCount);
