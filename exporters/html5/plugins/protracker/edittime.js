...
// jump controls back- fwd 
AddAction(21, 0, "Back", "Play", 
          "Backward Module Position", 
          "Backward Position", "Go_back"); 
		  
AddAction(22, 0, "Forward", "Play","Forward Module Position","Forward Position", "Go_fwd");

AddNumberParam("Number", "Set Separation Type ");
AddAction(23, 0, "Separation", "Play","Stereo Separation FX{0}","Stereo Separation Type 0 Wide/ 1 Stereo /2 Mono", "set_stereo");	
